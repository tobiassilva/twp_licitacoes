    ...
    return GridView.count(
      ...
      children: <Widget>[
        ...
        FlatButton(
          ...
          highlightColor: Colors.transparent,
          onPressed: () async {
            /*if(json['circuito'][0]['cidades'][valCidade]['curiosidades'] != null){
              Navigator.of(context).push(
                  MaterialPageRoute(
                      builder: (BuildContext context) =>
                          Curiosaide(valCidade)));
            }else {
              Flushbar(
                message: "Este guia não tem nenhum item cadastrado.!",
                duration: Duration(seconds: 3),
              )..show(context);
            }*/
          },
          child: _cardOpcoes("Estados", Colors.deepPurple,
              Colors.deepPurpleAccent, FontAwesomeIcons.city, globalsAdm.dbEstados.length),
          /*Column(
                          children: <Widget>[
                            Container(
                              child: Image.asset(
